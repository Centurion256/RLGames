...
if __name__ == "__main__":
    ...
    parser.add_argument("-g", "--game", default="pong", help="specify a game to be played/trained on. Defaults to 'Pong-Atari2600'")
    parser.add_argument("-a", "--algorithm", default="random", help="specify a algorithm to be used to train the agent. Defaults to 'random'")
